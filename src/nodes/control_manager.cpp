...
auto main(int argc, char** argv) -> int {
    ...
    ros::Rate rate(amr::utils::DEFAULT_LOOP_RATE * 2);

    amr::control::PID gains_xy{};
    amr::control::PID gains_yaw{};
    amr::control::PID gains_z{};
    ...
    // pid controller
    auto controller = amr::control::PIDController(nh, rate, gains_xy, gains_z, gains_yaw, true);
    controller.run();
